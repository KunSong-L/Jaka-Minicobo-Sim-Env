...
if __name__ == "__main__":     
    stlfile = "/home/song/Jaka_ROS/jaka_robot_20230314/src/data/curvenoisefilter.stl"
    ...
    pub = rospy.Publisher("robot_path_pub",PoseStamped,queue_size=10)
    msg=String()
    count=0
    rate=rospy.Rate(1)
    ...
    # 计算法向量
    pcd_path = "/home/song/Jaka_ROS/jaka_robot_20230314/src/data/curvenoisefilter.pcd"
